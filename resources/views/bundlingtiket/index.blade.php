...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">List Bundling Tiket Wisata</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <div class="col-sm-12 col-md-6">
            <div id="user1_filter" class="dataTables_filter">
                ...
                <label>
                    <input type="search" class="form-control form-control-sm" placeholder="Cari nama bundling tiket wisata . . ." aria-controls="user1">
                </label>
            </div>
        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('wisata.store') }}" method="POST" id="form-tambah-wisata" enctype="multipart/form-data" >
                                ...
                                <div class="modal-body">
                                    <div class="input">
                                        <label for="">Nama Bundling Tiket Wisata</label>
                                        <br>
                                        <input type="text" class="form-control" id="nama_wisata" name="nama_wisata" placeholder="Nama Bundling Tiket Wisata">
                                    </div>
                                    <br>
                                    <div class="input">
